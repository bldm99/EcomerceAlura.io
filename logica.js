...
const verProductos = (ubicacion , descripcion , imagen, id ) =>{
    ...
    const contenido = `
            <div class="caja-producto">
                ...
                <a href="./verproducto/producto.html?id=${id}" class="e"> Ver producto </a>
...
Datacel.Vercelulares().then((datos)=>{
    /*------------------Forma 1 de recorrer u json---------------*/
    /*datos.forEach(x => {
        const mostrar = verProductos(x.nombre , x.precio) 
        valuecelulares.appendChild(mostrar);
    });*/
    ...
    datos.map((x)=>{
        ...
        /*
        -------------Representacion de arbol del dom -----------------

        <div class="valuecelulares"> 
